...
- [x] 0. Create test project for the solution
  - [x] 0.1 Create xUnit test project `MediatR.Playground.Tests`
  ...
  - [x] 0.2 Write baseline smoke tests
  ...
  - [x] 0.3 Run tests and confirm they pass on the current codebase (pre-upgrade baseline)
...
- [x] 1. Upgrade TargetFramework to .NET 10 in all projects
...
- [x] 2. Upgrade Microsoft.* packages to 10.x
...
- [x] 4. Upgrade third-party NuGet packages
  - [x] 4.1 Upgrade FluentValidation packages
  ...
  - [x] 4.2 Upgrade FusionCache, Bogus, and Swashbuckle
...
- [x] 5. Build and test verification checkpoint
...
- [x] 6. Create docs/ folder and documentation files
  - [x] 6.1 Create `docs/pipelines.md`
  ...
  - [x] 6.2 Create `docs/unit-of-work.md`
  ...
  - [x] 6.3 Create `docs/exception-handling.md`
  ...
  - [x] 6.4 Create `docs/global-exception-handling.md`
  ...
  - [x] 6.5 Create `docs/notifications.md`
  ...
  - [x] 6.6 Create `docs/priority-notification-publisher.md`
  ...
  - [x] 6.7 Create `docs/stream-requests.md`
...
- [x] 7. Checkpoint — Review documentation files
...
- [x] 9. Final checkpoint — Verify everything compiles, tests pass, and links resolve
